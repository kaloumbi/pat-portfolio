// IMPORTATION JS & ASSETS
import "../assets/js/homeScript.js";

// Importation des images et fichiers
import kaloumbiImg from "../assets/images/kaloumbi.png";
import galaxyVideo from "../assets/images/galaxy.mp4";
import cvFile from "../assets/documents/pat_cv.pdf";
    ...
    <section class="main-section">
      ...
      <div class="hero">
        <div class="hero-info">
          ...
          <div class="Buttons">
            <a href="${cvFile}" class="btn" data-aos="zoom-in-right" data-aos-duration="1000" data-aos-delay="1100">
              Download Cv
            </a>
            <ul class="ul-icons">
        ...
        <div class="hero-img" data-aos="zoom-in-left" data-aos-duration="2500">
          <img src="${kaloumbiImg}" alt="person-img">
        </div>
      </div>
